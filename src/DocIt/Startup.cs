...
using DocIt.ActionFilters;
using DocIt.Data.DeveloperSample;
using DocIt.Middlewares;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new Info { Title = "DocIt API", Version = "v1" });
        ...
        {
            // Register Correlation ID handling
            app.UseCorrelator();
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "DocIt API V1");
            });
