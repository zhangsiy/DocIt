...
const app = 'DocIt'; //your app's name, used to generate names for infrastructures

const terraformStateS3Bucket = 'jeff-terraform-states'; // the s3 bucket where we will store our terraform files
const terraformAwsProfile = 'jeff-terraform-user';

const mainProjectName = 'DocIt'; // The name of the main/entry project.

const containerRegistryUri = "812358241507.dkr.ecr.us-east-1.amazonaws.com/docit_ecr"; // URI to locate the container image registry
